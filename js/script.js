...
const publicKey = "0c67411b69b272d214d35a5a7948d46e";
const privateKey = "ed032a376fcc91c45f8352dd7f7c0d9b5973fa27";
...
async function searchHeros(textSearched) {
  ...
  const url = `https://gateway.marvel.com:443/v1/public/characters?ts=${timestamp}&apikey=${publicKey}&hash=${hash}&nameStartsWith=${textSearched}`;
